...
GitHub Actions 会在工作日北京时间 10:00、11:20、13:30、14:30、20:00 自动运行 `scripts/generate_pool.py`。其中 10:00、11:20、13:30 属于买入复检窗口，14:30 属于尾盘卖出/风控，20:00 属于次日关注计划。每次运行都会刷新：
